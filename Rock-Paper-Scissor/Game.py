...
#picture read
rock_img = ImageTk.PhotoImage(Image.open("D:\\Rock-Paper-Scissor\\rock-user.png"))
paper_img = ImageTk.PhotoImage(Image.open("D:\\Rock-Paper-Scissor\\paper-user.png"))
scissors_img = ImageTk.PhotoImage(Image.open("D:\\Rock-Paper-Scissor\\scissors-user.jpg"))
rock_img_comp = ImageTk.PhotoImage(Image.open("D:\\Rock-Paper-Scissor\\rock.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("D:\\Rock-Paper-Scissor\\paper.png"))
